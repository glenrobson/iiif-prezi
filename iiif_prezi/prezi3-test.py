...
#   timestamp: 2021-09-10T13:06:34+00:00
...
from prezi3helper import Parent


class Behavior(Parent):
    __root__: List[
        Union[
...
class AnnoSelectorItem(Parent):
    type: str
    t: Optional[Duration] = None


class AnnoSelector(Parent):
    __root__: Union[AnyUrl, AnnoSelectorItem]


class ResourceItem1(Parent):
    id: Optional[Id] = None
...
class External(Parent):
    __root__: List[ExternalItem]


class KeyValueString(Parent):
    label: LngString
    value: LngString


class SpecificResource(Parent):
    id: Optional[Id] = None
...
class SeeAlso(Parent):
    __root__: External


class AnnoTarget(Parent):
